...
export default StylesJS = StyleSheet.create({
    ...
    button: { height: 45, flexDirection: 'row', backgroundColor:'#6897bb', borderColor: '#000000', borderWidth: 1, borderRadius: 8, marginBottom: 10, marginTop: 10,                     alignSelf: 'stretch', justifyContent: 'center'},
    
    villageHeader: { fontSize: 18, fontWeight: 'bold', alignSelf: 'center'},
    
    resourcesView: { alignItems: 'center', flexDirection: 'row', flex: 1, justifyContent:'space-evenly', color: '#0b1d1c'},
